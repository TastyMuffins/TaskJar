 ...
 */
public class ListProjectAdapter extends ArrayAdapter<ProjectItem> {

    Context context;

    public ListProjectAdapter(Context context, int resourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProjectItem rowItem = getItem(position);
